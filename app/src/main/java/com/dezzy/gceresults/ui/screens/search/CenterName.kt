...
fun SearchCenterName() {
    ...
    fun checkEnabled(): Boolean {
        return centerName.isNotEmpty() && selectedLevel != "Select Level" && year.isNotEmpty()
    }
